...
@CommandParameters(description = "Sets everyone's Worldedit block modification limit to a custom amount (defaults to 2500).", usage = "/<command> [limit]")
public class Command_setl extends TFM_Command {

    @Override
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole) {
        int limit = (args.length >= 1 ? Integer.parseInt(args[0]) : 2500);
