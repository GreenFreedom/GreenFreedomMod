...
public enum TFM_PlayerRank
{
    ...
    CHAR("the " + ChatColor.DARK_PURPLE+ "Co Chief Forum Dev" + ChatColor.DARK_PURPLE + ChatColor.AQUA + ", and a " + ChatColor.DARK_RED + "System-Admin", ChatColor.DARK_PURPLE + "§8[§5Co-Chief F-Dev§8]"),
